...
預設情況下，本軟體於本地運行，不會向 HakoSpace 傳送資料。然經您明確同意（Opt-in）後，本軟體可能收集並傳送匿名之使用與診斷數據（遙測）以協助改善軟體。此類數據絕對不包含個人資訊或使用者生成內容。關於資料收集與使用之詳細資訊，請參閱我們的隱私權政策。
