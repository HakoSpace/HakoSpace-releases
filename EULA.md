<!--
  ...
  Source of Truth:   hakofront/src/pages/legal/archive/2026-07-08/
...
This End-User Licence Agreement is identified by its **effective date**, shown at the top of the document (current version: **EULA effective 2026-07-08**). The Privacy Policy is versioned independently, likewise by effective date. HakoSpace may update either document from time to time; a material change will trigger a new effective date.
...
The prohibitions in this Section 3 are subject to Section 14 (Third-Party Open-Source Components).
...
This Section 4 is subject to Section 14 (Third-Party Open-Source Components); the third-party open-source components included in the software remain the property of their respective authors.
...
Your acceptance of this §11 and the accompanying Privacy Policy's media-data-flow disclosure is recorded under the version-and-re-consent mechanism in §1.1 (EULA effective 2026-07-08).
...
14.1 The software incorporates certain third-party open-source components, each of which is provided to you under its own applicable open-source licence (including, for example, the GNU Lesser General Public License ("LGPL"), the BSD licences, the Apache License 2.0, and the MIT License). A list of these components together with their respective licences and attributions is provided in the `THIRD_PARTY_NOTICES` file distributed with the software.
 

14.2 **Notwithstanding Section 3 (Prohibited Activities), Section 4 (Intellectual Property), or any other provision of this Agreement, nothing in this Agreement limits, restricts, or overrides any right granted to you under the licence of any such third-party open-source component.** To the extent of any conflict between this Agreement and the licence of a third-party open-source component with respect to that component, the terms of that component's own licence prevail.
 

14.3 In particular, where an included component is licensed under the LGPL, you retain the rights that licence grants you, including the right to reverse engineer that component solely to the extent necessary to debug modifications you make to it, and the right to run a modified version of that component by replacing it within the software, in each case as and to the extent permitted by the applicable version of the LGPL.
 

14.4 The prohibitions in Section 3 and the ownership statement in Section 4 apply only to the HakoSpace-authored portions of the software; they do not extend to the third-party open-source components, which remain the property of their respective authors and are governed solely by their respective licences.
