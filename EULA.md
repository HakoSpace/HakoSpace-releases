...
This End-User Licence Agreement is identified by its **effective date**, shown at the top of the document (current version: **EULA effective 2026-06-16**). The Privacy Policy is versioned independently, likewise by effective date. HakoSpace may update either document from time to time; a material change will trigger a new effective date.
...
Your acceptance of this §11 and the accompanying Privacy Policy's media-data-flow disclosure is recorded under the version-and-re-consent mechanism in §1.1 (EULA effective 2026-06-16).
