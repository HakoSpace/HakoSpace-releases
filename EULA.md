...
## 11. User-Generated Content and Communications

HakoSpace is self-hosted software. You are solely responsible for all data, content, and communications transmitted, stored, or processed using the software. HakoSpace does not host, monitor, or control your instances, and has no access to your user-generated content or communications. HakoSpace assumes no liability for any user-generated content or illegal activities conducted through your use of the software.

## 12. Privacy and Telemetry

By default, the software operates locally and does not transmit data to HakoSpace. However, with your explicit opt-in consent, the software may collect and transmit anonymous usage and diagnostic data (telemetry) to help improve the software. This data does not include personal information or user-generated content. For more details on data collection and usage, please refer to our Privacy Policy at https://hakospace.com/privacy.
...
HakoSpace 授予您有限、非專屬、不可轉讓且可撤銷的授權，允許您依本合約條款安裝及使用本軟體，僅供您個人使用。除此之外，不授予任何其他權利。

## 2. 許可使用範圍

本軟體僅限於下列情形使用：

- **學術用途**：於經認可之學術機構從事研究、學習或教育目的。
- **個人非商業用途**：個人或社群使用。允許接受自願性贊助（如 Patreon、斗內）僅用於支付運行本軟體之基礎設施與主機費用。但嚴禁收取強制性存取費用、設置付費牆，或利用本軟體進行營利。
- **符合資格之非營利組織**：持有有效非營利資格之組織，且不得以本軟體從事營利或提供付費服務。

**任何層級之政府機關均不在許可使用範圍內**，如需使用本軟體，須另行與 HakoSpace 簽訂書面協議。

## 3. 禁止行為

下列行為嚴格禁止：

- 對本軟體進行逆向工程、反編譯、反組譯，或以任何方式嘗試還原其原始碼。
- 擷取、重建或推導本軟體之原始碼、演算法或內部邏輯之任何部分。
- 移除、修改、繞過或規避本軟體內嵌之任何授權驗證機制、著作權聲明或保護措施。
- 將本軟體重新散布、轉售、出租、租賃或再授權予任何第三方。
- 以任何名稱重新封裝或重新品牌化本軟體，並作為任何其他產品之一部分進行散布。
- 利用本軟體向第三方提供商業託管、SaaS 或代管服務。

## 4. 智慧財產權

本軟體之一切權利、所有權及利益，包括所有智慧財產權，均專屬於 HakoSpace 所有。本合約不移轉任何所有權予您。您僅取得依本合約所述之有限使用權。

## 5. 更新

HakoSpace 得自行決定是否提供本軟體之更新、修補程式或新版本。除非另附獨立授權，否則任何更新均適用本合約。於更新後繼續使用本軟體，即表示您接受任何修訂後之條款。

## 6. 終止

本授權自生效起持續有效，直至終止為止。若您違反本合約任何條款，本授權將自動終止，無需另行通知。授權終止後，您須立即停止使用本軟體，並銷毀您持有或控制之所有副本。

## 7. 免責聲明

本軟體係以**「現狀」**提供，不附任何明示或默示之保證，包括但不限於適售性、特定目的適用性或不侵權之保證。HakoSpace 不保證本軟體不含錯誤或能持續不中斷運作。

## 8. 責任限制

在適用法律允許之最大範圍內，HakoSpace 對於因您使用或無法使用本軟體所引起之任何間接、附帶、特殊、衍生或懲罰性損害，概不負責，即使 HakoSpace 已被告知此類損害之可能性亦然。在任何情況下，HakoSpace 對您所有損害之賠償總額，最高不超過五美元（$5.00）。

## 9. 合約變更

HakoSpace 保留隨時修改本合約之權利。修訂後之合約將透過本軟體或其官方管道公告。於變更公告後繼續使用本軟體，即視為您接受修訂後之合約內容。

## 10. 準據法與管轄法院

本合約之解釋與適用均依中華民國（台灣）法律為準。因本合約所生或與本合約有關之任何爭議，雙方同意以台灣台北地方法院為第一審管轄法院。

## 11. 使用者生成內容與通訊

HakoSpace 為自建型軟體。您須對使用本軟體傳輸、儲存或處理之所有資料、內容與通訊負完全責任。HakoSpace 不託管、不監控亦不控制您的伺服器實例，且無法存取您的使用者生成內容或通訊。HakoSpace 對任何使用者生成內容或透過本軟體進行之非法活動概不負責。

## 12. 隱私與遙測

預設情況下，本軟體於本地運行，不會向 HakoSpace 傳送資料。然經您明確同意（Opt-in）後，本軟體可能收集並傳送匿名之使用與診斷數據（遙測）以協助改善軟體。此類數據絕對不包含個人資訊或使用者生成內容。關於資料收集與使用之詳細資訊，請參閱我們的隱私權政策：https://hakospace.com/privacy。

## 13. 語言版本優先權

本合約備有英文與繁體中文版本。若兩語言版本之間存在任何歧義或不一致之處，概以繁體中文版本為準。
