...
## 11. User-Generated Content and Data

HakoSpace is self-hosted software. You are solely responsible for all data, content, and communications transmitted, stored, or processed using the software. HakoSpace does not host, access, monitor, or control your instances, and assumes no liability for any user-generated content or illegal activities conducted through your use of the software.
...
HakoSpace 為自建型軟體。您須對使用本軟體傳輸、儲存或處理之所有資料、內容與通訊負完全責任。HakoSpace 不託管、不存取、不監控亦不控制您的伺服器實例，且對任何使用者生成內容或透過本軟體進行之非法活動概不負責。
